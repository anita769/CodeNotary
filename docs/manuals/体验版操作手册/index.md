...
> **注意：公网演示站 `https://ara.sciba.cn` 已于 2026-09-24 赛后下线**。本手册保留为操作实录与本地复现对照——用 `scripts/one_click_setup.sh` 本地起站后，可按本手册逐步对照操作。
> 适用对象（存档时）：访问公网演示站 `https://ara.sciba.cn` 的访客。
